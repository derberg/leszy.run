...
export const CITY_LOCATIVE = {
  ...
  'Gołąbki': 'w Gołąbkach',
  'Hajnówka': 'w Hajnówce',
  'Jelcz-Laskowice': 'w Jelczu-Laskowicach',
  ...
  'Oława': 'w Oławie',
  'Opole': 'w Opolu',
  'Paprocany': 'w Paprocanach',
  'Piekary Śląskie': 'w Piekarach Śląskich',
  'Police': 'w Policach',
  'Poznań': 'w Poznaniu',
  'Radom': 'w Radomiu',
  'Ruda Śląska': 'w Rudzie Śląskiej',
  'Rybnik': 'w Rybniku',
  'Rytro': 'w Rytrze',
  'Rzeszów': 'w Rzeszowie',
  'Siedlce': 'w Siedlcach',
  'Sieradz': 'w Sieradzu',
  'Sopot': 'w Sopocie',
  'Strzyżów': 'w Strzyżowie',
  'Suwałki': 'w Suwałkach',
  'Szczecin': 'w Szczecinie',
  'Szklarska Poręba - Jakuszyce': 'w Szklarskiej Porębie',
  'Tarnów': 'w Tarnowie',
  'Tczew': 'w Tczewie',
  'Toruń': 'w Toruniu',
  'Tychy': 'w Tychach',
  ...
  'Wodzisław Śląski': 'w Wodzisławiu Śląskim',
  'Wrocław': 'we Wrocławiu',
  'Zielona Góra': 'w Zielonej Górze',
}

// Cities that are not real cities and should not get landing pages
export const CITY_BLOCKLIST = new Set(['Polska'])
